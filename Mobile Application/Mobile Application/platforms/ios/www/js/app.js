...
.run(function($ionicPlatform,ConnectivityMonitor) {
  $ionicPlatform.ready(function() {
   ...
   // .value('urlprefix', "http://192.168.1.11/muhafiz/UserScripts/")
     //.value('urlprefix', "http://192.168.1.7/muhafiz/UserScripts/")
  // .value('urlprefix', "http://localhost/muhafiz/UserScripts/")
     .value('urlprefix', "http://muhafiz2.azurewebsites.net/Api/UserScripts/")
